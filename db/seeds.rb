...
4.times do
  Host.create!({ username: Faker::Superhero.name,
                ...
                new_exp: rand(1..5),
                openness: rand(0.0..0.999),
                conscientiousness: rand(0.0..0.999),
                extraversion: rand(0.0..0.999),
                agreeableness: rand(0.0..0.999),
                emotional_range: rand(0.0..0.999)
                })
end
